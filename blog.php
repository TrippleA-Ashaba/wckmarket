							...
							<div class="row gy-4 posts-list">
									...
									<article class="d-flex flex-column">
										...
										<h2 class="title">
											<a href="blog-details.html"
												>Forex or Stock Market? Which is better? What is the
												Forex market?</a
											>
										</h2>
										...
										<div class="content">
											<p>
												...
												marketplace in which currencies can be bought, sold,
												and exchanged. The participants in this market range
												from banks, individual retail traders, and even
									...
									<article class="d-flex flex-column">
										...
										<h2 class="title">
											<a href="/blog-details2.html"
												>MT4 app for iOS has been removed from the Appstore,
												where to find a replacement?</a
											>
										</h2>
										...
										<div class="meta-top">
											<ul>
												<li class="d-flex align-items-center">
													<i class="bi bi-person"></i>
													<a href="/blog-details2.html">John Doe</a>
												</li>
												<li class="d-flex align-items-center">
													<i class="bi bi-clock"></i>
													<a href="/blog-details2.html"
												...
												<li class="d-flex align-items-center">
													<i class="bi bi-chat-dots"></i>
													<a href="/blog-details2.html">12 Comments</a>
												</li>
											</ul>
										</div>
										...
										<div class="content">
											<p>
												In early October, Apple removed the mobile versions
												of the MT4 and MT5 trading platforms from its
												Appstore. The reason is alleged non-compliance with
												guidelines by the developers of the MetaTrader 4 and
												...
											</p>
										</div>

										<div class="read-more mt-auto align-self-end">
											<a href="/blog-details2.html">Read More</a>
										</div>
									</article>
								</div>
								<!-- End post list item -->
								...
								<div class="col-lg-6">
									<article class="d-flex flex-column">
										...
										<h2 class="title">
											<a href="blog-details.html"
												>Possimus soluta ut id suscipit ea ut. In quo quia
												et soluta libero sit sint.</a
											>
										</h2>
								...
								<div class="col-lg-6">
									<article class="d-flex flex-column">
										...
										<div class="content">
											<p>
												In itaque assumenda aliquam voluptatem qui
												temporibus iusto nisi quia. Autem vitae quas aperiam
												nesciunt mollitia tempora odio omnis. Ipsa odit sit
												ut amet necessitatibus. Quo ullam ut corrupti autem
												consequuntur totam dolorem.
											</p>
										</div>
								...
								<div class="col-lg-6">
									<article class="d-flex flex-column">
										...
										<h2 class="title">
											<a href="blog-details.html"
												>Distinctio provident quibusdam numquam aperiam
												aut</a
											>
										</h2>
										...
										<div class="content">
											<p>
												...
												architecto praesentium dolores. Illo laboriosam
												officiis quis. Labore officia quia sit voluptatem
												nisi est dignissimos totam. Et voluptate et
												consectetur voluptatem id dolor magni impedit. Omnis
												dolores sit.
											</p>
										</div>
									...
									<div class="mt-3">
										...
										<div class="post-item">
											...
											<div>
												<h4>
													<a href="blog-post.html"
														>Id quia et et ut maxime similique occaecati
														ut</a
													>
												</h4>
												<time datetime="2020-01-01">Jan 1, 2020</time>
