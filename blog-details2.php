					...
					<div class="row g-5">
						<div class="col-lg-8">
							<article class="blog-details">
								...
								<div class="meta-top">
									<ul>
										<li class="d-flex align-items-center">
											...
											<a href="blog-details.html">Julia Parker</a>
										</li>
										<li class="d-flex align-items-center">
											<i class="bi bi-clock"></i>
											<a href="blog-details.html"
												><time datetime="2020-12-10">Dec 10, 2022</time></a
											>
										</li>
										<li class="d-flex align-items-center">
								...
								<div class="content">
									<p>
										In early October, Apple removed the mobile versions of the
										MT4 and MT5 trading platforms from its Appstore. The reason
										is alleged non-compliance with guidelines by the developers
										of the MetaTrader 4 and MetaTrader 5 mobile apps. If you're
										looking for a quality mobile app for trading on financial
										markets, Spotware's cTrader mobile app could be a suitable
										replacement.
									</p>

									<blockquote>
										<p>
											Spotware's cTrader mobile app could be a suitable
											replacement.
										</p>
									</blockquote>
									...
									<p>
										Although the developers at MetaQuotes, the studio behind the
										MT4 iOS app, say they are currently doing everything they
										can to bring MetaTrader 4 and MetaTrader 5 back to the Apple
										Appstore, it is impossible to say at the moment when this
										will happen. So traders who can't do without trading on
										their iPhones have two choices - either wait for MT4 to
										return ti Appstore or find a suitable alternative. One such
										alternative is offered by Purple Trading - it is the cTrader
										mobile trading platform from Spotware.
									</p>
								</div>
								<!-- End post content -->
